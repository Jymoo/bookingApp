...
public class AddTips extends AppCompatActivity {
    ...
    StorageReference reference = FirebaseStorage.getInstance().getReference("Tips");
    ...
    public void uploadToFirebase(Uri uri){
        ...
        fileRef.putFile(uri).addOnSuccessListener(taskSnapshot -> fileRef.getDownloadUrl().
                addOnSuccessListener(uri1 -> {
                    ...
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(AddTips.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
            ...
            progressBar.setVisibility(View.INVISIBLE);
            Toast.makeText(AddTips.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
        });
    }
